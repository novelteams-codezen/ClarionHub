...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ClarionHub", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<ClarionHubContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "ClarionHub API v1");
